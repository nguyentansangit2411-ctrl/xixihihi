        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZaloLink = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceLink = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SellerRatings_Users_ReviewerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_Category_Status_IsDeleted",
                table: "Products",
                columns: new[] { "CategoryId", "Status", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_Province_Status_IsDeleted",
                table: "Products",
                columns: new[] { "ProvinceId", "Status", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Products",
                columns: new[] { "Status", "IsDeleted", "Price" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_WardId",
                table: "Products",
                column: "WardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerRatings_ReviewerId",
                table: "SellerRatings",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_SellerRatings_SellerId_ReviewerId",
                table: "SellerRatings",
